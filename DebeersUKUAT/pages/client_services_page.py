...
class Client_Services_Page(BasePage):
    ...
    def test_email_us_form(self):
        try:
            ...
            self.fill(self.email_message,"[UK WEBSITE] SUBMITTED EMAIL US FORM FOR THE REGRESSION TESTING..")
            self.timeout(1000)
            ...
            print("*****[EMAIL US] NOT ABLE TO SUBMIT THE FORM..")
    ...
    def test_close_email_us_form(self):
        try:
            ...
            print("*****[EMAIL US] NOT ABLE TO CLOSE THE FORM..*****")
    ...
    def test_callback_form(self):
        try:
            ...
            print("*****[CALL REQUEST] NOT ABLE TO SUBMIT THE FORM..*****")
    ...
    def test_close_callback_form(self):
        try:
            ...
            print("*****[CALL REQUEST] NOT ABLE TO CLOSE THE FORM..*****")