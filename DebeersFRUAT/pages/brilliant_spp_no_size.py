...
class BB_SPP_No_Size(BasePage):
        ...
        def test_bb_spp_no_size_with_engraving(self):
            try:
                ...
                print(f"[BB SPP WITHOUT SIZE AND WITH ENGRAVING] {self.SKU1} IS ADDED TO THE CART..")
                self.screenshot.take_page_screenshot("BB_SPP_NO_SIZE_ADDED_WITH_ENGRAVING")
                self.click(self.minicart_close_icon)
            except:
                print(f"*****[BB SPP WITHOUT SIZE AND WITH ENGRAVING] {self.SKU1} IS NOT ADDED TO THE CART..*****")
        ...
        def test_bb_spp_no_size_without_engraving(self):
            try:
                ...
                self.timeout(2000)
                print(f'[BB SPP WITHOUT SIZE AND WITHOUT ENGRAVING] {self.SKU2} IS ADDED TO THE CART..')
                ...
                print(f'*****[BB SPP WITHOUT SIZE AND WITHOUT ENGRAVING] {self.SKU2} IS NOT ADDED TO THE CART..*****')
