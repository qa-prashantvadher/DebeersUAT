...
class Open_Shopping_Cart_Page(BasePage):
    ...
    def test_open_shopping_cart_page(self):
        try:
            ...
            self.timeout(2000)
            print("[HEADER] USER IS REDIRECTED TO THE CART PAGE..")
            self.screenshot.take_page_screenshot("CART_PAGE")
        except:
            print("*****[HEADER] USER IS NOT REDIRECTED TO THE CART PAGE..*****")
    ...
    def test_continue_to_checkout_from_cart(self):
        try:
            ...
            self.timeout(5000)
            print("[CART] USER IS REDIRECTED TO THE DELIVERY PAGE..")

        except:
            print("*****[CART] USER IS NOT REDIRECTED TO THE DELIVERY PAGE..*****")
