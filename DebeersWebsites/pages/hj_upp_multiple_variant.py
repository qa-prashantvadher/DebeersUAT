...
class HJ_UPP_Multiple_Variant(BasePage):
        ...
        def test_hj_upp_multiple_variant_with_engraving(self):
            try:
                ...
                logger.info(f"[HJ UPP MULTIPLE VARIANT WITH ENGRAVING] {self.SKU1} IS ADDED TO THE CART..")
                ...
                logger.info(f"[HJ UPP MULTIPLE VARIANT WITH ENGRAVING] {self.SKU1} ENGRAVING TEXT IS UPDATED..")
                #self.screenshot.take_Page_screenshot("HJ_UPP_MULTIPLE_UPDATE_ENGRAVING")
            except:
                logger.error(f"*****[HJ UPP MULTIPLE VARIANT WITH ENGRAVING] {self.SKU1} IS NOT ADDED TO THE CART..*****")
        ...
        def test_hj_upp_multiple_variant_without_engraving(self):
            try:
                ...
                self.timeout(2000)
                logger.info(f"[HJ UPP MULTIPLE VARIANT WITHOUT ENGRAVING] {self.SKU2} ENGRAVING TEXT IS ADDED..")
                ...
                logger.error(f"*****[HJ UPP MULTIPLE VARIANT WITHOUT ENGRAVING] {self.SKU2} IS NOT ADDED TO THE CART..*****")